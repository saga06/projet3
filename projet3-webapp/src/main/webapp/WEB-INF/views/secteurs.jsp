...
<html>
    ...
    <body>
        ...
        <div class="maindiv">
            <div class="container">
                <h2>Ici vous trouverez la liste des secteurs du site selectionné</h2>
            ...
            <div class="container">
                ...
                <c:forEach var="infoComment" items="${ infoComments }">
                    <p>L'utilisateur : <b><c:out value="${ infoComment.user_nickname }" /></b> a laissé le commentaire suivant :</p>
