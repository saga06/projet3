...
<html>
    ...
    <%@include file="include/menu.jsp"%>
        <div class="maindiv">
            <div class="container">
                <h2>Ici tu trouveras la liste des longueurs de la voie sélectionnée</h2>
            ...
            <div class="container">
                <h3>Tu souhaites ajouter une nouvelle longueur à cette voie ? Merci de compléter ces champs :</h3>
